...
- `vgl.sparse` for cached COO/CSR/CSC adjacency layouts, multi-value edge payloads, transpose/reduction helpers, and sparse operators such as scalar `spmm(...)`, `sddmm(...)`, and `edge_softmax(...)`
